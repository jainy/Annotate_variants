...
--hgvs id based on genome is used for annotation
...
--hgvs id based on genome is used for annotation, (not sure hgvs id based of coding/protein would make a difference, most likely not)
